public class Outlander extends Car {
    ...
    public void accelerate(int rate) {
        ...
        else if(newVelocity > 40 && newVelocity <= 50) changeGear(5);
        else if(newVelocity > 40 && newVelocity <= 60) changeGear(6);

        if(newVelocity > 0) changeVelocity(newVelocity, getCurrentDir());
    }
}
